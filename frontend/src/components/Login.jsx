  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', backgroundColor: 'var(--sub-bg)' }}>
      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: '500px' }}>
          ...
          <p style={{ fontFamily: '"Montserrat", sans-serif', fontSize: '1.35rem', lineHeight: '1.6', opacity: 0.95, margin: 0, textShadow: '0 2px 5px rgba(0,0,0,0.5)', fontWeight: 300 }}>
            Crafting the perfect blend of rich coffee and seamless digital experiences. Please sign in to access your station.
          </p>
        </div>
      </div>
      ...
      <div 
        ...
        backgroundImage: 'radial-gradient(circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(99, 102, 241, 0.25) 0%, rgba(236, 72, 153, 0.15) 25%, transparent 50%)',
        position: 'relative',
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: '3rem', textAlign: 'center' }}>
            <h2 style={{ fontFamily: '"Montserrat", sans-serif', fontSize: '2rem', fontWeight: 700, color: '#18181b', margin: '0 0 0.5rem 0', letterSpacing: '-0.5px' }}>Welcome Back</h2>
            <p style={{ fontFamily: '"Inter", sans-serif', fontSize: '1rem', color: '#71717a', margin: 0 }}>Please enter your details to sign in.</p>
          </div>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, color: '#3f3f46', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Password</label>
              <div style={{ position: 'relative' }}>
